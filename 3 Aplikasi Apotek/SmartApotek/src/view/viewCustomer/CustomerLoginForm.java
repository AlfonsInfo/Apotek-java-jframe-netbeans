...
public class CustomerLoginForm extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
      //  System.out.println(inputUsername.getText());
       // System.out.println(inputPassword.getText());
        AkunCustomer as = akunCustomerControl.searchAkunCustomer(inputUsername.getText(),inputPassword.getText());
        if(as==null)
        {
        ...
        {          
            ...
            //Delay 
            //Pindah form 
            CustomerForm dv = new CustomerForm();
            this.dispose();
            dv.setVisible(true);
        }
    ...
    private void btnSignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignupActionPerformed
         CustomerSignUpForm dv = new CustomerSignUpForm();
         this.dispose();
         dv.setVisible(true);
