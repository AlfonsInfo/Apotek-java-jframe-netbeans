...
//id karyawan, namaKaryawan, gaji,tunjangan, Username, Departemen, 

public class TableManajer extends AbstractTableModel{

    private List<Manajer> list;   
    
    public TableManajer(List<Manajer> list)
    {
        this.list = list;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch(columnIndex)
        {
            ...
            case 3:
                return list.get(rowIndex).getTunjangan();
            case 4:
